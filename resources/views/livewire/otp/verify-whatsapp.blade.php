...
>
    <div class="mb-4 text-center">
        <flux:heading level="2">{{ __('Verify your phone (WhatsApp)') }}</flux:heading>
    ...
    <div class="grid gap-4">
        ...
        <div class="grid gap-2">
            <flux:label for="wa-code">{{ __('Verification code') }}</flux:label>
            <flux:input id="wa-code" wire:model.defer="code" inputmode="numeric" autocomplete="one-time-code"
